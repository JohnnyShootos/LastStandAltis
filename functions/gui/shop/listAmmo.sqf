...
lbClear _ctrl;
{
	...
	_ctrl lbAdd gettext (configFile >> "CfgMagazines" >> configName _x >> "displayName");
	_ctrl lbSetPicture [_foreachindex, gettext (configFile >> "CfgMagazines" >> configName _x >> "picture")];
...
} foreach ("isclass _x" configClasses (missionconfigfile >> "ShopList" >> "AmmoList"));
