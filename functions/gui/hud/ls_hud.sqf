...
#define GET_ARMOR(unit) (unit getVariable ['jsh_armor',0])
...
#define ARMOR_ICON  "\a3\ui_f\data\gui\cfg\communicationmenu\defend_ca.paa"
...
while {alive player} do
{
	...
	_hud_armor_bar = _ui displayCtrl IDC_LASTSTANDHUD_LS_HUDARMORBAR;
	_hud_health_icon = _ui displayCtrl IDC_LASTSTANDHUD_LS_HUDHEALTHICON;
	_hud_armor_icon = _ui displayCtrl IDC_LASTSTANDHUD_LS_HUDARMORICON;
	...
	_hud_health_icon ctrlSetText HEALTH_ICON; _hud_health_icon ctrlSetTextColor [0.8, 0, 0, 1];
	_hud_armor_icon ctrlSetText ARMOR_ICON; _hud_armor_icon ctrlSetTextColor [0, 0, 0.8, 1];
	_hud_armor_bar progressSetPosition _armor; _hud_armor_bar ctrlCommit 1;
	...
	_hud_cash_text ctrlSetStructuredText parseText format ["<img size='1.75' image='\a3\modules_f_curator\data\portraitcuratoraddpoints_ca.paa'/> %1", GET_CASH(player)];
